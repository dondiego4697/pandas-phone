...
CREATE TABLE IF NOT EXISTS iphone_order (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    model IPHONE_MODEL_T NOT NULL,
    color IPHONE_COLOR_T NOT NULL,
    memory_capacity IPHONE_MEMORY_T NOT NULL,
...
CREATE TABLE IF NOT EXISTS airpod_order (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    series AIRPOD_SERIES_T NOT NULL,
    original BOOLEAN DEFAULT FALSE,
    charging_case BOOLEAN DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS order_item (
    ...
    iphone_id UUID REFERENCES iphone_order(id) ON DELETE RESTRICT UNIQUE,
    airpod_id UUID REFERENCES airpod_order(id) ON DELETE RESTRICT UNIQUE
);
